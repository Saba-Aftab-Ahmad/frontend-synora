...
export function About() {
  return (
    <section
      id="about"
      className="relative py-8 md:py-10 bg-[#060810]/40"
    >
      {/* Background Effect */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-purple/10 rounded-full blur-[150px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-5">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f4ff]">
            Built for <span
              style={{
                background: 'linear-gradient(135deg, #7c3aed, #06b6d4)',
                WebkitBackgroundClip: 'text',
          ...
          <p className="mt-2 text-sm text-[#8892b0] max-w-xl mx-auto">
            A comprehensive toolkit designed to make federated learning accessible to researchers and developers.
          </p>
        </div>
        ...
        {/* 6 Cards Grid - 3x2 layout */}
        <div
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mb-5"
          ...
          {features.map((feature) => (
            ...
            >
              <div
                ...
                style={{ background: 'rgba(124, 58, 237, 0.15)' }}
              >
                <feature.icon className="h-4 w-4" style={{ color: '#a78bfa' }} />
              </div>
              <h3 className="text-base font-semibold text-[#f0f4ff] mb-1">
                {feature.title}
              </h3>
              <p className="text-[#8892b0] text-xs leading-snug">
                {feature.description}
              </p>
            </div>
          ))}
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          >
            <p className="text-sm md:text-base italic text-[#f0f4ff]/90 leading-snug">
              &ldquo;Empowering a more inclusive AI future by enabling privacy-preserving machine learning for underrepresented languages and communities worldwide.&rdquo;
            </p>
            <footer className="mt-2 text-xs text-[#8892b0]">
              — The Synora Mission
            </footer>
          </blockquote>
        </div>
